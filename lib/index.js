...
class AutoI18nPlugin {
    constructor(options) {
        ...
        this.filePreprocessor = new file_preprocessor_1.FilePreprocessor(this.chineseExtractor);
    }
    apply(compiler) {
        // 检测是否为开发模式
        ...
        if (this.options.transformCode) {
            compiler.hooks.beforeCompile.tapAsync('AutoI18nPlugin', async (params, callback) => {
