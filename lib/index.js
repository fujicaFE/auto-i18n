...
class AutoI18nPlugin {
    constructor(options) {
        ...
        this.options = Object.assign({ outputPath: './src/locales', presets: {}, exclude: [], ignoreComments: true, debugExtraction: false, apiKey: '', apiProvider: 'preset', sourceLanguage: 'zh', targetLanguages: ['en', 'zh-TW'], enableProductionAnalysis: false, skipExistingTranslation: true }, options);
