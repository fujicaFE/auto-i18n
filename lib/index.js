...
class AutoI18nPlugin {
    constructor(options) {
        ...
        this.options = Object.assign({ outputPath: './src/locales', presets: {}, exclude: [], ignoreComments: true, apiKey: '', apiProvider: 'preset', sourceLanguage: 'zh', targetLanguages: ['en', 'zh-TW'], enableProductionAnalysis: false }, options);
        ...
        this.filePreprocessor = new file_preprocessor_1.FilePreprocessor(this.chineseExtractor, this.options.codeStyle);
    }
    apply(compiler) {
        // 检测是否为开发模式
        ...
        if (this.options.transformCode) {
            compiler.hooks.beforeCompile.tap('AutoI18nPlugin', (params) => {
                // 防止重复处理和循环调用
